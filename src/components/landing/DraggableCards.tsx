...
const CARDS = [
  ...
  { src:'photo-1573496359142-b8d87734a5a2', name:'Ariana M.', goal:'Launched her brand', badge:'$10k first month', rot:2.5, delay:'0.4s', top:30, right:0, w:230, h:290, zIdx:2 },
  { src:'photo-1500648767791-00dcc994a43e', name:'Marcus L.', goal:'Saved first $50k', badge:'4 months early', rot:1, delay:'0.8s', bottom:10, left:60, w:210, h:260, zIdx:1 },
]
