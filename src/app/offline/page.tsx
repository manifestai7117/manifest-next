  ...
  return (
    <div className="min-h-screen bg-[#f8f7f5] flex items-center justify-center p-6">
      <div className="text-center max-w-[360px]">
        ...
        <h1 className="font-serif text-[32px] mb-3">You're offline</h1>
        <p className="text-[14px] text-[#666] leading-[1.7] mb-6">No internet connection. Your data is safe — check-ins will sync when you're back online.</p>
